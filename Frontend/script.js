...
function validateRegisterForm(formData) {
    ...
    if (!formData.name || formData.name.trim().length < 2) {
        showError(document.getElementById('registerName'), 'Please enter your full name');
        isValid = false;
    } else {
    ...
    if (!formData.phone || !validatePhone(formData.phone)) {
        showError(document.getElementById('registerPhone'), 'Please enter a valid phone number');
        isValid = false;
    } else {
    ...
    if (!formData.password || !validatePassword(formData.password)) {
        showError(document.getElementById('registerPassword'), 'Password must be at least 8 characters with uppercase, lowercase, and number');
        isValid = false;
    } else {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('registerFormElement').addEventListener('submit', function(e) {
        ...
        // Simulate API call
        setTimeout(() => {
            alert('Registration successful! Please check your email for verification. Redirecting to homepage...');
            submitBtn.textContent = originalText;
            submitBtn.disabled = false;
            grecaptcha.reset();
    ...
    const registerInputs = ['registerName', 'registerEmail', 'registerPhone', 'registerPassword', 'confirmPassword'];
